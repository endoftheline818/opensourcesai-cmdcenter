...
(`src/derive/bands.js`), the fit engine (`src/derive/fit.js`), the site design
tokens, and the HUD social palette. **MAINTAINING.md §7 carries the complete
table** of what is copied, from where, and which fixture pins it — read it there
rather than trusting a second copy of the list.
